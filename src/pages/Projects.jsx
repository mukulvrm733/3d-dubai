...
const projects = [
  {
    ...
    loc: 'Majan, Dubailand, Dubai', priceRaw: 699999, price: 'Starting from AED 699,999',
    beds: 1, sqft: '401 – 2,235 sq. ft.', developer: 'Binghatti',
                  ...
                  <div className="flip-card__back-content">
                    ...
                    <div>
                      ...
                      <div className="flip-card__btns">
                        <a href="#" className="flip-btn flip-btn--explore">Explore</a>
